...
export CORE_PEER_ADDRESS=192.168.8.120:7004
export CORE_PEER_TLS_ROOTCERT_FILE=/vars/keyfiles/peerOrganizations/citizen.auto.com/peers/peer1.citizen.auto.com/tls/ca.crt
export CORE_PEER_LOCALMSPID=citizen-auto-com
export CORE_PEER_MSPCONFIGPATH=/vars/keyfiles/peerOrganizations/citizen.auto.com/users/Admin@citizen.auto.com/msp
...
jq '.channel_group.groups.Application.groups."citizen-auto-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "192.168.8.120","port": 7004}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
